...
const mainimage = "https://i.postimg.cc/DzTYChJx/stranger-things.webp"
const title = "https://i.postimg.cc/sxspBjk9/stranger-things-title.webp"
function Tvshow() {
    const scroll = {
        dots: false,
        infinite: true,
    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <p className="seriescontent">When a young boy vanishes, a small town uncovers a mystery<br />involving secret experiments, terrifying supernatural forces and<br />one strange little girl.</p>
            ...
            <div className="secondintermediateTVSHOW"></div>
            <div className="secondcontentTVSHOW">
