...
function MOVIES() {
    ...
    const mainimage = "https://i.postimg.cc/43ynyB7M/angrybirdposter.webp";
    const title = "https://i.postimg.cc/h41gFVh7/angrybird.webp";
    return (
        <>
        <Navbar />
            <div className="container">
                ...
                <p className="seriescontent">Sentenced to anger management class, grumpy Red becomes a<br/>hero who trains his fellow birds to unleash their inner fury when<br/>pigs invade their island.</p>
            ...
            <div className="secondintermediateMOVIES"></div>
            <div className="secondcontentMOVIES">
