...
function SampleNextArrow(props) {
    ...
    return (
        <div
            className={className}
            style={{ ...style, background: "#ffffff5b", height: "100px", display: "flex", alignItems: "center" }}
            onClick={onClick}
        />
    );
}
...
const mainimage = "https://i.postimg.cc/MKF1BBN5/The-Parasite.webp";
const title = "https://i.postimg.cc/fbxd1rLq/parasyte-title.webp";
return (
    <>
        <Navbar />
        <div className="container">
            ...
            <p className="seriescontent">Koo Kyo-hwan ("D.P.") stars as a flailing gang member who fights<br/>to protect a woman-parasite hybrid from those who hunt her, and<br/>find his missing sister.</p>
            ...
            <span className="censor">A</span>
        </div>
        <div className="secondintermediate"></div>
