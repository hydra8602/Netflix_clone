        ...
        <>
            ...
            <div className="mainarea">
                <div className='mainareainner'>
                    <h1 className='signinmain'>Sign In</h1>
                    <input className='input' type='textbox' value={username} onChange={(e) => setUsername(e.target.value)} placeholder='Email or phone number' /><br /><br />
                    <input className='input' type='password' value={password} onChange={(e) => setPassword(e.target.value)} placeholder='Password' /><br /><br />
                    <button className='signinbutton' onClick={nextpage}>Sign In</button>
                    <p style={{ textAlign: "center", padding: "5px" }}>OR</p>
                    <button className='signincodebutton'>Use a Sign-in Code</button><br />
                    <a href='#' className='forgetpassword'><p style={{ textAlign: "center" }}>Forgot Password?</p></a>
                    <input type="checkbox" id="myCheckbox" className="customcheckbox" />
                    <label style={{ marginLeft: "5px" }} htmlFor="myCheckbox">Remember Me</label>
                    <p style={{ marginLeft: "75px", color: "rgba(255,255,255,0.7)" }}>New to Netflix?<Link to="/"><a href='#' className='signupnow'>Sign up now</a></Link></p>
                    <span className='googlerecaptcha'>This page is protected by Google reCAPTCHA to<br /><span style={{ marginLeft: "75px" }}>ensure you're not a bot.</span><button onClick={googlerecaptcha} className='learnmorebutton'>Learn More.</button></span>
            ...
            <div className='footer'>
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item" onClick={changetohindi} href="#">हिन्दी</a></li>
                    </ul>
                </div> */}

                <div className='phonenum'>Questions ? Call 000-800-919-1694</div>
                <div className='footerlinks'>
                    <div className='footercontainer'>
                    <div> <a>FAQ</a></div>
                    <div><a>Help Center</a> </div>
                    </div>
                    <div className='footercontainer'>
                    <div><a>Terms of Use</a> </div>
                    <div><a>Corporate Information</a> </div>
                    
                    </div>
                    <div><a>Privacy</a> </div>
                    <div><a>Cookies Preferences</a> </div>
                </div>
                <div class="phonenum">
                    <button class="btn btn-secondary dropdown-toggle Dropdownedited" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="default-ltr-cache-4z3qvp e1svuwfo1" data-name="Languages" aria-labelledby=":R26aqkqela9:" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.7668 5.33333L10.5038 5.99715L9.33974 8.9355L8.76866 10.377L7.33333 14H9.10751L9.83505 12.0326H13.4217L14.162 14H16L12.5665 5.33333H10.8278H10.7668ZM10.6186 9.93479L10.3839 10.5632H11.1036H12.8856L11.6348 7.2136L10.6186 9.93479ZM9.52722 4.84224C9.55393 4.77481 9.58574 4.71045 9.62211 4.64954H6.41909V2H4.926V4.64954H0.540802V5.99715H4.31466C3.35062 7.79015 1.75173 9.51463 0 10.4283C0.329184 10.7138 0.811203 11.2391 1.04633 11.5931C2.55118 10.6795 3.90318 9.22912 4.926 7.57316V12.6667H6.41909V7.51606C6.81951 8.15256 7.26748 8.76169 7.7521 9.32292L8.31996 7.88955C7.80191 7.29052 7.34631 6.64699 6.9834 5.99715H9.06968L9.52722 4.84224Z" fill="currentColor"></path></svg>English
