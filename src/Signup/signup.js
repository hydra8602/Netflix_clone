...
function signup() {
    return (
        <>
            <div>
                <img className="bgimage" src="https://i.postimg.cc/cLDJs3ht/Netflix-Background.jpg"></img>
            </div>
            ...
            <div className="netflixlogo">
                ...
                <Link to="/sign"><button className='signin'> Sign In </button> </Link>
            </div>
            <div className="Seconddiv">
                <div className="seconddivinner">
                    <h1 style={{ fontSize: "48px", fontWeight: "900", color: "white" }}>Unlimited movies,<br /> TV shows and more</h1>
                    <h3 style={{ font: "inherit", fontSize: "22px", fontWeight: "550", color: "white" }}>Starts at ₹149. Cancel anytime.</h3>
                    <h4 style={{ font: "inherit", fontSize: "15px", color: "white" }}>Ready to watch? Enter your email to create or restart your membership.</h4>
                    <div className="emailinput">
                        <input className="email-input" name="email" placeholder="Email address" />
                        {/* <label for="email">Email address</label> */}
                        <button className="getStartButton buttonLabel">Get Started
                        <svg className="rightArrow" width="20px" height="20px" viewBox="0 0 1024 1024" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg"><path d="M256 120.768L306.432 64 768 512l-461.568 448L256 903.232 659.072 512z" fill="#ffffff" /></svg>
                        </button>
                    </div>
                </div>
            </div>
            <div className="secDivBelow"></div>
            <div className="secDivDown"></div>
            <div className="thirdDiv">
                <h1 className="thirdDiv trending-label" style={{ font: "inherit", fontSize: "20px", color: "white", paddingTop: "20px" }}>Trending Now</h1>
            ...
            <div className="lastHeader">
                <div className="lastHeaderInner">
                    <h1 style={{ fontSize: "48px", fontWeight: "900", color: "white", margin: "0px", padding: "30px" }}>Frequently Asked Questions</h1>
                </div>
                <div className="accordian">
                    <Accordion allowZeroExpanded>
                        <AccordionItem>
                            <AccordionItemHeading>
                                <AccordionItemButton style={{backgroundColor:"#2d2d2d", color:"White"}}>
                                    What id Netflix?
                                </AccordionItemButton>
                            </AccordionItemHeading>
                            <AccordionItemPanel style={{backgroundColor:"#2d2d2d", width:"99.5%",color:"White"}}>
                                <p>
...
Kids profiles come with PIN-protected parental controls that let you restrict the maturity rating of content kids can watch and block specific titles you don’t want kids to see.
                ...
                <div className='footermsg'>
                    <div className='phnumber'><p>Questions? Call</p></div>
                    <div className='phnumber'><a href="">000-800-919-1694</a></div>
                </div>
                <div className='footerlinks'>
                    <div className='links1'><a href="">FAQ</a></div>
                    <div className='links1'><a href="">Help Centre</a></div>
                    <div className='links1'><a href="">Terms of Use</a></div>
                    <div className='links1'><a href="">Privacy</a></div>
                </div>
                <div className='footerlinks2'>
                    <div className='links2'><a href="">Cookie Preferences</a></div>
                    <div className='links2'><a href="">Corporate Information</a></div>
                </div>
                <div class="dropdown">
                    <button class="btn btn-secondary dropdown-toggle Dropdownedited" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="default-ltr-cache-4z3qvp e1svuwfo1" data-name="Languages" aria-labelledby=":R26aqkqela9:" aria-hidden="true"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.7668 5.33333L10.5038 5.99715L9.33974 8.9355L8.76866 10.377L7.33333 14H9.10751L9.83505 12.0326H13.4217L14.162 14H16L12.5665 5.33333H10.8278H10.7668ZM10.6186 9.93479L10.3839 10.5632H11.1036H12.8856L11.6348 7.2136L10.6186 9.93479ZM9.52722 4.84224C9.55393 4.77481 9.58574 4.71045 9.62211 4.64954H6.41909V2H4.926V4.64954H0.540802V5.99715H4.31466C3.35062 7.79015 1.75173 9.51463 0 10.4283C0.329184 10.7138 0.811203 11.2391 1.04633 11.5931C2.55118 10.6795 3.90318 9.22912 4.926 7.57316V12.6667H6.41909V7.51606C6.81951 8.15256 7.26748 8.76169 7.7521 9.32292L8.31996 7.88955C7.80191 7.29052 7.34631 6.64699 6.9834 5.99715H9.06968L9.52722 4.84224Z" fill="currentColor"></path></svg>English
                    </button>
